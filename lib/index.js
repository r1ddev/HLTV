...
var connectToMatchesScorebot_1 = require("./endpoints/connectToMatchesScorebot");
var Hltv = /** @class */ (function () {
    function Hltv(config) {
        ...
        this.connectToMatchesScorebot = (0, connectToMatchesScorebot_1.connectToMatchesScorebot)(this.config);
        ...
        if (config.httpAgent && !config.loadPage) {
            config.loadPage = (0, config_1.defaultLoadPage)(config.httpAgent, config.requestMethod);
        }
        if (!config.httpAgent) {
