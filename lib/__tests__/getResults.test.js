...
test('getResults', function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.sent();
                _a = expect;
                return [4 /*yield*/, src_1.default.getResults({ eventIds: [1617] })];
            case 2:
            ...
            case 3:
                _c.sent();
                _b = expect;
                return [4 /*yield*/, src_1.default.getResults({
                        playerIds: [7998],
