                            ...
                            switch (_d.label) {
                                ...
                                case 2:
                                    ...
                                    results.push.apply(results, $('.result-con')
                                        ...
                                        var event = el.find(".event-name").text();
                                        var _a = el
                                            .find('.result-score')
                                            .text()
                                            .split(' - ')
                                            .map(Number), team1Result = _a[0], team2Result = _a[1];
                                        return __assign({ id: id, stars: stars, date: date, team1: team1, team2: team2, event: event, result: { team1: team1Result, team2: team2Result } }, (format.includes('bo')
                                            ? { format: format }
